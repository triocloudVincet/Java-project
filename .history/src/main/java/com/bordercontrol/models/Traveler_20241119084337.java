...
public class Traveler {
    ...
    public String getActiveFlagType() { return activeFlagType; }
    public void setActiveFlagType(String activeFlagType) { this.activeFlagType = activeFlagType; }
