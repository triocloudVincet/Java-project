...
public class DatabaseUtil {
    ...
    private static final String PASSWORD = "4732"; // Set your MySQL password here
    ...
    public static void createTables() {
        ...
        String createFlaggedTravelersTable = """
    ...
    """;
        ...
        try (Connection conn = getConnection()) {
            ...
            conn.createStatement().execute(createFlaggedTravelersTable);
